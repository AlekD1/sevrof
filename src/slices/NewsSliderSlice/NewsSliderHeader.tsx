        ...
        <div className="NewsSlider__slider__header__info">
            ...
            <div className="NewsSlider__slider__header-icons">
                ...
                <svg
                    ...
                    onClick={() => window.open( data && data.join ? data?.vk.value : '#', '_ blank')}
...
export default NewsSliderHeader;
